...
import com.zxl.database.Database0Config;
import com.zxl.database.Database1Config;
 ...
 * 其余使用database1库
 * Created by zxl on 2019/6/1.
 */
@Component
public class DatabaseShading implements SingleKeyDatabaseShardingAlgorithm<Long> {
